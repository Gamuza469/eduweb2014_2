...
class gsp_eduweb2014_2_actividadedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',33,['bean':(actividadInstance),'var':("error")],3)
printHtmlPart(23)
})
invokeTag('hasErrors','g',35,['bean':(actividadInstance)],2)
printHtmlPart(16)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('hiddenField','g',37,['name':("version"),'value':(actividadInstance?.version)],-1)
printHtmlPart(25)
...
invokeTag('form','g',44,['url':([resource:actividadInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1407561714655L
