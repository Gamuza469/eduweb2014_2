...
class gsp_eduweb2014_2_apuntecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/apunte/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'apunte.label', default: 'Apunte'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',31,['bean':(apunteInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',33,['bean':(apunteInstance)],2)
printHtmlPart(15)
createTagBody(2, {->
printHtmlPart(23)
...
invokeTag('form','g',41,['url':([resource:apunteInstance, action:'save'])],2)
printHtmlPart(26)
})
...
public static final long LAST_MODIFIED = 1407562181266L
