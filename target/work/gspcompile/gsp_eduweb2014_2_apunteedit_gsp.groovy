...
class gsp_eduweb2014_2_apunteedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/apunte/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'apunte.label', default: 'Apunte'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',33,['bean':(apunteInstance),'var':("error")],3)
printHtmlPart(23)
})
invokeTag('hasErrors','g',35,['bean':(apunteInstance)],2)
printHtmlPart(16)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('hiddenField','g',37,['name':("version"),'value':(apunteInstance?.version)],-1)
printHtmlPart(25)
...
invokeTag('form','g',44,['url':([resource:apunteInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1407562180577L
