...
class gsp_eduweb2014_2_comentariocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',31,['bean':(comentarioInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',33,['bean':(comentarioInstance)],2)
printHtmlPart(15)
createTagBody(2, {->
printHtmlPart(23)
...
invokeTag('form','g',41,['url':([resource:comentarioInstance, action:'save'])],2)
printHtmlPart(26)
})
...
public static final long LAST_MODIFIED = 1407564380472L
