...
class gsp_eduweb2014_2_loginauth_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(4)
expressionOut.print(assetPath(src:'chicos.png'))
printHtmlPart(5)
invokeTag('message','g',142,['code':("springSecurity.login.header")],-1)
printHtmlPart(6)
...
printHtmlPart(10)
invokeTag('message','g',150,['code':("springSecurity.login.username.label")],-1)
printHtmlPart(11)
invokeTag('message','g',155,['code':("springSecurity.login.password.label")],-1)
printHtmlPart(12)
...
printHtmlPart(15)
invokeTag('message','g',161,['code':("springSecurity.login.remember.me.label")],-1)
printHtmlPart(16)
...
public static final long LAST_MODIFIED = 1407548025144L
