...
class gsp_eduweb2014_2_mensajeindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mensaje/index.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',12,['action':("join")],2)
printHtmlPart(3)
})
