...
class gsp_eduweb2014_2_usuarioedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',33,['bean':(usuarioInstance),'var':("error")],3)
printHtmlPart(23)
})
invokeTag('hasErrors','g',35,['bean':(usuarioInstance)],2)
printHtmlPart(16)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('hiddenField','g',37,['name':("version"),'value':(usuarioInstance?.version)],-1)
printHtmlPart(25)
...
invokeTag('form','g',44,['url':([resource:usuarioInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1407561340732L
